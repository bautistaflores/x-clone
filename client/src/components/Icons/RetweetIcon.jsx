...
function RetweetIcon({ isRetweeted, width = 20, height = 20, color = 'currentColor' }) {
    return (
        <svg 
            ...
            height={height}
            viewBox="0 0 21 21"
        ><g fill='none' fillRule="evenodd" stroke={color} strokeWidth={isRetweeted ? "2" : "1.5"} strokeLinecap="round" strokeLinejoin="round" transform="translate(1 4)"> 
